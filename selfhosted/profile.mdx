---
title: Profile Page
description: "SlugBase documentation: Profile Page."
---
...
**Screenshot placeholder:** Profile Overview

**Asset file:** `profile-overview.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/profile-overview.png** (use the screenshot label above as alt text).
...
#### Go preferences
- A link to **Go preferences** (path: `/go-preferences`) lets you manage default slug behavior and open the [Search Engine Guide](/selfhosted/search-engine-guide) for browser keyword setup.
...
**Screenshot placeholder:** Profile Email Edit Mode

**Asset file:** `profile-email-edit.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/profile-email-edit.png** (use the screenshot label above as alt text).
...
**Screenshot placeholder:** Email Verification Pending

**Asset file:** `profile-email-pending.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/profile-email-pending.png** (use the screenshot label above as alt text).
...
**Screenshot placeholder:** Profile Preferences

**Asset file:** `profile-preferences.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/profile-preferences.png** (use the screenshot label above as alt text).
...
- [Admin](/selfhosted/admin) - Admin user management
...
- Password changes handled on separate [Password Reset](/selfhosted/password-reset) page
