---
title: Tags Page
description: "SlugBase documentation: Tags Page."
---
...
**Screenshot placeholder:** Tags Overview

**Asset file:** `tags-overview.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/tags-overview.png** (use the screenshot label above as alt text).
...
**Screenshot placeholder:** Create Tag Modal

**Asset file:** `tag-modal-create.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/tag-modal-create.png** (use the screenshot label above as alt text).
...
**Screenshot placeholder:** Tags Empty State

**Asset file:** `tags-empty-state.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/tags-empty-state.png** (use the screenshot label above as alt text).
...
- Bookmarks are shown on the [Bookmarks](/selfhosted/bookmarks) page with tag badges
...
- [Bookmarks](/selfhosted/bookmarks) - View bookmarks filtered by tag
