---
title: Admin Page
description: "SlugBase documentation: Admin Page."
---
...
**Screenshot placeholder:** Admin Page Overview

**Asset file:** `admin-overview.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/admin-overview.png** (use the screenshot label above as alt text).
...
**Screenshot placeholder:** Admin Users Tab

**Asset file:** `admin-users-tab.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/admin-users-tab.png** (use the screenshot label above as alt text).
...
**Screenshot placeholder:** Admin User Modal

**Asset file:** `admin-user-modal.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/admin-user-modal.png** (use the screenshot label above as alt text).
...
**Screenshot placeholder:** Admin Teams Tab

**Asset file:** `admin-teams-tab.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/admin-teams-tab.png** (use the screenshot label above as alt text).
...
**Screenshot placeholder:** Admin Team Modal

**Asset file:** `admin-team-modal.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/admin-team-modal.png** (use the screenshot label above as alt text).
...
**Screenshot placeholder:** Admin OIDC Providers Tab

**Asset file:** `admin-oidc-tab.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/admin-oidc-tab.png** (use the screenshot label above as alt text).
...
**Screenshot placeholder:** Admin OIDC Provider Modal

**Asset file:** `admin-oidc-modal.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/admin-oidc-modal.png** (use the screenshot label above as alt text).
...
**Screenshot placeholder:** Admin Settings Tab

**Asset file:** `admin-settings-tab.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/admin-settings-tab.png** (use the screenshot label above as alt text).
...
- [Login](/selfhosted/login) - User authentication
- [Profile](/selfhosted/profile) - User profile management
- [Setup](/selfhosted/setup) - Initial system setup
