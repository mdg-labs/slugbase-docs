...
**Screenshot placeholder:** SlugBase Dashboard

**Asset file:** `intro-hero.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/intro-hero.png** (alt: use the label above).
