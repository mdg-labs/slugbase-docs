...
description: "SlugBase documentation: Bookmarks Page."
---
...
**Screenshot placeholder:** Bookmarks Card View

**Asset file:** `bookmarks-card-view.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/bookmarks-card-view.png** (use the screenshot label above as alt text).
...
**Screenshot placeholder:** Bookmarks List View

**Asset file:** `bookmarks-list-view.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/bookmarks-list-view.png** (use the screenshot label above as alt text).

</Callout>

<Callout kind="tip">

**Screenshot placeholder:** Bookmarks Table View

**Asset file:** `bookmarks-table-view.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/bookmarks-table-view.png** (use the screenshot label above as alt text).
...
**Screenshot placeholder:** Bookmarks Toolbar

**Asset file:** `bookmarks-toolbar.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/bookmarks-toolbar.png** (use the screenshot label above as alt text).
...
**Screenshot placeholder:** Global Search Modal

**Asset file:** `bookmarks-global-search.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/bookmarks-global-search.png** (use the screenshot label above as alt text).
...
**Screenshot placeholder:** Create Bookmark Modal

**Asset file:** `bookmark-modal-create.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/bookmark-modal-create.png** (use the screenshot label above as alt text).
...
**Screenshot placeholder:** Bookmark Modal with Forwarding

**Asset file:** `bookmark-modal-forwarding.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/bookmark-modal-forwarding.png** (use the screenshot label above as alt text).
...
**Screenshot placeholder:** Bulk Actions Bar

**Asset file:** `bookmarks-bulk-actions.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/bookmarks-bulk-actions.png** (use the screenshot label above as alt text).
...
**Screenshot placeholder:** Bookmarks Empty State

**Asset file:** `bookmarks-empty-state.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/bookmarks-empty-state.png** (use the screenshot label above as alt text).
...
- [Folders](/selfhosted/folders) - Folder management
- [Tags](/selfhosted/tags) - Tag management
- [Shared](/selfhosted/shared) - Shared bookmarks view
- [Search Engine Guide](/selfhosted/search-engine-guide) - Custom search engine setup
