---
title: Folders Page
description: "SlugBase documentation: Folders Page."
---
...
**Screenshot placeholder:** Folders Overview

**Asset file:** `folders-overview.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/folders-overview.png** (use the screenshot label above as alt text).
...
**Screenshot placeholder:** Create Folder Modal

**Asset file:** `folder-modal-create.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/folder-modal-create.png** (use the screenshot label above as alt text).
...
**Screenshot placeholder:** Folder Icon Picker

**Asset file:** `folder-modal-icon-picker.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/folder-modal-icon-picker.png** (use the screenshot label above as alt text).
...
**Screenshot placeholder:** Folders Empty State

**Asset file:** `folders-empty-state.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/folders-empty-state.png** (use the screenshot label above as alt text).
...
- Bookmarks are shown on the [Bookmarks](/selfhosted/bookmarks) page with folder badges
...
- [Bookmarks](/selfhosted/bookmarks) - View bookmarks filtered by folder
- [Shared](/selfhosted/shared) - View shared folders
