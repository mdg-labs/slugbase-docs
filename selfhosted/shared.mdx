---
title: Shared Page
description: "SlugBase documentation: Shared Page."
---
...
**Screenshot placeholder:** Shared Bookmarks Tab

**Asset file:** `shared-bookmarks-tab.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/shared-bookmarks-tab.png** (use the screenshot label above as alt text).
...
**Screenshot placeholder:** Shared Folders Tab

**Asset file:** `shared-folders-tab.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/shared-folders-tab.png** (use the screenshot label above as alt text).

</Callout>

<Callout kind="tip">

**Screenshot placeholder:** Shared Bookmark Card Detail

**Asset file:** `shared-bookmark-card.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/shared-bookmark-card.png** (use the screenshot label above as alt text).
...
- [Bookmarks](/selfhosted/bookmarks) - View own bookmarks
- [Folders](/selfhosted/folders) - View own folders
- [Profile](/selfhosted/profile) - User profile and settings
