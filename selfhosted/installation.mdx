...
<Steps>
  ...
  <Step title="Choose how you will run SlugBase" icon="workflow" titleType="p">
    ...
    - **Production in Docker:** pull **`mdglabs/slugbase`** from Docker Hub or build from the root `Dockerfile` (see [Docker](/selfhosted/docker) and [Docker Compose](/selfhosted/docker-compose)).
  </Step>
