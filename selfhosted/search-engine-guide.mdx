...
description: "SlugBase documentation: Search Engine Guide."
---
...
**Screenshot placeholder:** Search Engine Guide Overview

**Asset file:** `search-engine-guide-overview.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/search-engine-guide-overview.png** (use the screenshot label above as alt text).
...
- [Bookmarks](/selfhosted/bookmarks) - Create bookmarks with slugs
- [Profile](/selfhosted/profile) - Manage account and remembered slug choices
...
**Screenshot placeholder:** Search URL Display

**Asset file:** `search-engine-guide-url.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/search-engine-guide-url.png** (use the screenshot label above as alt text).
