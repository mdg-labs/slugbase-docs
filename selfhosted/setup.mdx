---
title: Setup Page
description: "SlugBase documentation: Setup Page."
---
...
**Screenshot placeholder:** Setup Form

**Asset file:** `setup-form.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/setup-form.png** (use the screenshot label above as alt text).
...
**Screenshot placeholder:** Setup Success

**Asset file:** `setup-success.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/setup-success.png** (use the screenshot label above as alt text).
...
- [Login](/selfhosted/login) - Post-setup authentication
- [Admin](/selfhosted/admin) - Admin panel (accessible after login as first user)
