...
From Profile you can open **Go preferences** (path: `/app/go-preferences` on Cloud, `/go-preferences` when self-hosted) to manage default slug behavior and view the [Search Engine Guide](/cloud/search-engine-guide) for browser keyword setup.
...
- [Admin](/cloud/admin) - Organization and billing management (admins/owners)
- [Password Reset](/cloud/password-reset) - Recovering your password
- [Search Engine Guide](/cloud/search-engine-guide) - Browser custom search setup
