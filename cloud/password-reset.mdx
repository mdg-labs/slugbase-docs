...
description: "SlugBase documentation: Password Reset Page."
---
...
**Screenshot placeholder:** Password Reset Request

**Asset file:** `password-reset-request.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/password-reset-request.png** (use the screenshot label above as alt text).
...
**Asset file:** `password-reset-form.png`

Upload this file in the Documentation.AI Web Editor (media library), then remove this callout and insert the image at **/assets/password-reset-form.png** (use the screenshot label above as alt text).
...
- [Login and Auth](/cloud/auth) - Sign in to SlugBase Cloud
- [Login](/cloud/login) - Login page (entry point and post-reset destination)
